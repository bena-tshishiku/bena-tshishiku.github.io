...
* (9/25). HW3 is posted below due next friday Oct 2 by 5pm. 
* (9/20). Some solutions to HW1 are posted below. (I cannot promise that I will post solutions to every assignment.)
* (9/18). Office hours for the semester have been set for Tu 5:30-6:30 in Salomon 004 (me) and Th 5:30-6:30 in Salomon 202 (Sarah). 
...
## Grading
participation 5%, homework 10%, quizzes 20%, 1st midterm 20%, 2nd midterm 20%, final exam 25%, 
...
* TA: Sarah Yan (sarah_yan at brown.edu) 

## Course events 

* Lectures: MW 8:30-9:50 in Bio-Med B13. 
* Bena's office hour: Tu 5:30-6:30 in Salomon 004 
* Sarah's office hour:  Th 5:30-6:30 in Salomon 202
...
[HW1](https://bena-tshishiku.github.io/files/courses/2026-fall/1460-hw1.pdf), [solutions](https://bena-tshishiku.github.io/files/courses/2026-fall/hw1-solutions.pdf)

[HW2](https://bena-tshishiku.github.io/files/courses/2026-fall/1460-hw2.pdf)

[HW3](https://bena-tshishiku.github.io/files/courses/2026-fall/1460-hw3.pdf)
...
* Feed it your solutions and to check for correctness. Learning to critique your own arguments is an objective of this course. Before submitting work, you should check it by returning to the definitions, testing the argument on examples, verifying that every hypothesis has been used appropriately, and discussing with me, Sarah, or your classmates.
...
At the beginning of every class there will be a small warm-up activity/exercise that will be turned in and graded based on completion only. These activities will have an educational component, but they are also there to encourage you to show up to class on time (I know it's early).  

### Lecture notes

I am not planning to post any lecture notes. I believe it is part of your responsibility to come to class and write down what you think is important. This is a basic way to engage with the material. 


## Topic schedule (subject to change)

* Week 1: Gamelin Chapter I, Section 1-2, 5
  * Wed (9/9). Overview, complex arithmetic, complex exponential 

* Week 2: Gamelin Chapter I, Sections 4,7,8; Chapeter II, Sections 1-3
  * Mon (9/14). Complex derivatives, square roots 
  * Wed (9/16). holomorphic functions, open sets, CR equations
  * Fri (9/17). HW1 due. 

* Week 3: Gamelin Chapter 2, Sections 5; Chapter 3, Sections 1-3, 
  * Mon (9/21). complex logarithm, Cauchy-Riemann equations 
  * Wed (9/23). visualizing holomorphic functions, harmonic conjugates 
  * Fri (9/24). HW2 due

* Week 4: Gamelin Chapter 4, Sections 1-6
  * Mon (9/28). complex integration, Green’s theorem and Cauchy’s theorem, antiderivatives
