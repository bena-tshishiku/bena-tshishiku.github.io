...
* Come to office hours (ask questions related to homework, lecture, or the book; go over something you're confused about; work on your homework alone or in a group; ask for advice on how to improve in the course; ask about something only tangentially related to the course)
* A pretty good general approach to doing homework problems (UMER): (1) **U**nderstand the problem: review all relevant definitions, do some examples, draw a picture; (2) **M**ake a plan: which results from class are relevant, come up with strategies to solve the problem; (3) **E**xecute: try one of your strategies, and if it doesn't work (this is normal), try another and go back to steps (1) and (2) as necessary; (4) **R**eflect on your solution: after you've solved the problem, go back over your work, did you miss any steps, can you simplify /improve/conceptualize your solution, extract any big-picture take-aways. Overall, the homework should be fun if you have a good sense of UMER. 